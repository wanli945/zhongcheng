...
export default (baseURL, unit) => {
    return {
        post: {
            baseURL: baseURL,    // 基准路径  在index.js 修改，一个文件夹 为一个路径
            url: "/tamll/queryterminl", // 拼接的 相对路径
            params: {
                pageSize: 1,
                pageNum: 1,
                random: 0,
            ...
            realParam({queryOption, pagination, id = undefined, random = 0, userInfo, pageRight} = {}) {
                if (id) {
                    ...
                    return {
                        ...
                        phone, // 手机号
                        servicename: Servicename || (servicename === '所有人' ? '' : servicename), // 业务员
                        ...
                        terminalseries: "",
                        terminaltyp: "",
                        sname: (Servicename || servicename) ? null : 1,
                        failure,
