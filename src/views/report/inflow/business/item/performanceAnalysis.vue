<!--
 ...
 --@author   : 李艳鹏
 --@Software : app
 --@File     : PerformanceAnalysis
 --@describe : 业绩分析
-->
<template>
    <my-plat title="业绩分析" ref="plat" :button-arr="productArr" @choose="chooseChannel">
        <template #content>
...
<script>
    ...
    import {getPerformance} from "../data/mock"
    ...
    export default {
        ...
        data() {
            const columnArr = [
                {label: "业务员", prop: 'serverName'},
                {label: "外呼量", prop: 'callNum'},
        ...
        methods: {
            ...
            async getProductRank() {
                ...
                this.total = 0;
                try {
                    const {total, dataArr} = await getPerformance(this);
