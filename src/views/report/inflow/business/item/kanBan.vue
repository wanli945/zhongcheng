...
-->
<template>
    <my-plat title="商机看板" ref="plat" :button-arr="infoFlowArr" @choose="chooseChannel">
        <template #content>
            <div class="overAllBox" ref="overAll">
                <template v-for="(item,index) in kanBanData">
            ...
            <!--<v-echarts style="height: 450px;margin-top: 10px" autoresize
...
<script>
    ...
    import {kanBanData} from "../data/mock";
        ...
        methods: {
            ...
            async getkanBanData() {
                try {
                    ...
                    this.kanBanData = await kanBanData(this);
                    this.options.platType = this.kanBanData[0].category;
            ...
            /* async chooseOverData(index) {
                 await this.kanBanData.forEach((value, index1) => {
                     this.$set(this.kanBanData[index1], 'cur', index === index1);
                     if (index1 === index) {
