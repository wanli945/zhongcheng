<!--
 ...
 --@author   : 李艳鹏
 --@Software : app
 --@File     : channelAnalysis
 --@describe : 渠道分析
-->

<template>
    <my-plat title="渠道分析" ref="plat" :button-arr="productArr" @choose="chooseChannel">
        <template #content>
...
<script>
    ...
    import {getChannelData} from "../data/mock"
    ...
    export default {
        ...
        data() {
            const columnArr = [
                {label: "广告来源", prop: "advertisers", width: "200"},
                {label: "商机数", prop: "num"},
        ...
        methods: {
            ...
            async getProductRank() {
                ...
                this.total = 0;
                try {
                    const {total, dataArr} = await getChannelData(this);
