...
<template>
    <el-tabs v-model.trim="activeName">
        <el-tab-pane name="first" label="单个导入">
            <div class="editBox" v-if="activeName==='first'">
                <el-form size="small" style="height: 440px" :model="addDialog.data"
                         ...
                         ref="addFinance">
                    <el-form-item label="天猫订单号" prop="tmallId">
                        <el-input v-model.trim="addDialog.data.tmallId"
        ...
        <template v-if="api.daoruexcele">
            <el-tab-pane name="second" disabled label="批量导入">
...
<script>
    import {businessAllAdvertiser, businessDefaultChannel} from "../../../../../data/status.data.js"
    ...
    export default {
            ...
            return {
                ...
                addDialog: {
                    data: {
                        ...
                        name: "", // 客户姓名
                        interior: "", // 装机地址
                        channels: businessDefaultChannel.tmall.default, // 来源
                        channel: "", // 来源
                        area: "", //  区域
                    ...
                    rules: {
                        ...
                        tmallId: {required: true, message: '请填写天猫订单号', trigger: 'blur'},
                        // nameofadvertiser: {required: true, message: '请选择广告主名称', trigger: 'blur'},
                        idcard: [
                            {
                                validator: (rule, value, callback) => {
                    ...
                    option: {
                        channel: [],
                        advertiserList: businessAllAdvertiser["tmall"]
                    },
                },
        ...
        methods: {
            async init() {
                try {
                    const {dataObj, channelDict} = await this.$root.query_channel(true, businessDefaultChannel['tmall'].channelArr)
