...
-->
<template>
    <order-page order-type="b2i" :storage-column="this.$c_B2Iordertable"
                :table-column="tableColumn" :api="api" ref="B2IQuery"></order-page>
</template>

<script>
    import orderPage from "../item/index"
            ...
            return {
                ...
                * */
                tableColumn: [
                    ...
                    {label: "B2I单号", field: "B2IId", width: "150"},
                    {label: "TM单号", field: "TMId", width: "150"},
                    {label: "TM状态", field: "TMStatus", width: "150"},
                    {label: "销售价", field: "sellingPrice", width: "150"},
